...
const navLinks = [
  { label: "レポートの中身", href: "#report" },
  { label: "安心への設計", href: "#assurance" },
    ...
    <>
      ...
      >
        <div className="mx-auto flex h-[72px] max-w-[1920px] items-center justify-between px-5 md:h-[88px] md:px-10 lg:px-[72px]">
          {/* Logo + 保護者レポート tag */}
          <a href="#top" className="flex shrink-0 items-center gap-3" aria-label="SAMPO STUDY 保護者レポート">
            <Image
              ...
              priority
            />
            <span className="hidden border-l border-border pl-3 text-[12px] font-bold text-[#5c7066] sm:inline lg:text-[13px]">
              保護者レポート
            </span>
          </a>
